...
public class IndependentGizmo implements ClientModInitializer {
	...
	public static final KeyBinding TOGGLE_GIZMO_CROSSHAIR = KeyBindingHelper.registerKeyBinding(
			new KeyBinding("key.independent.gizmo.gizmo_crosshair_toggle", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_GRAVE_ACCENT, "key.categories.independent_gizmo"));
	public static final KeyBinding GIZMO_SIZE_UP = KeyBindingHelper.registerKeyBinding(
			new KeyBinding("key.independent.gizmo.gizmo_size_up", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_KP_ADD, "key.categories.independent_gizmo"));
	public static final KeyBinding GIZMO_SIZE_DOWN = KeyBindingHelper.registerKeyBinding(
			new KeyBinding("key.independent.gizmo.gizmo_size_down", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_KP_SUBTRACT, "key.categories.independent_gizmo"));
